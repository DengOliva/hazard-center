(function () {
  ...
  function drawCharts() {
    ...
    if (allS.length) {
      ...
      drawLineChart("chart-star5", [
        ...
        { labels: star6.map(function (d) { return d.month; }), data: star6.map(function (d) { return d.score; }), color: "#e05555" }
      ], smin, smax);
    }
    ...
    if (allA.length) {
      ...
      drawLineChart("chart-aqhb", [
        { labels: aq5.map(function (d) { return d.month; }), data: aq5.map(function (d) { return d.score; }), color: "#0d9488" },
  ...
  var TYPE_COLORS = [
    "#e05555", "#409eff", "#e6a23c", "#0d9488", "#8b5cf6", "#f97316",
